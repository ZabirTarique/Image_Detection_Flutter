...
import 'package:image_label_flutter/painter/label_detector_painter.dart';
import 'package:image_label_flutter/utils.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Image Detection App'),
        centerTitle: true,
        elevation: 0,
      ),
      body: SafeArea(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                if (choices[index].title == 'From Assets') {
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => const ImageLabelView()));
                                }
                              },
                              child: Card(
                                  color: Colors.orange,
